...
class chatterRoomWindow5(QDialog, QWidget, form_chatterRoom):
    ip = 'localhost'
    port = 5555
    # 채팅방1
    wait_port = 9999
    ...
    def __init__(self, id):
        super(chatterRoomWindow5, self).__init__()
    ...
    def conn(self):
        ...
        self.conn_socket.connect((chatterRoomWindow5.ip, chatterRoomWindow5.port))
        self.conn_socket2.connect((chatterRoomWindow5.ip, chatterRoomWindow5.wait_port))
