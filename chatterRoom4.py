...
class chatterRoomWindow4(QDialog, QWidget, form_chatterRoom):
    ip = 'localhost'
    port = 4444
    # 채팅방1
    wait_port = 9999
    ...
    def __init__(self, id):
        super(chatterRoomWindow4, self).__init__()
    ...
    def conn(self):
        ...
        self.conn_socket.connect((chatterRoomWindow4.ip, chatterRoomWindow4.port))
        self.conn_socket2.connect((chatterRoomWindow4.ip, chatterRoomWindow4.wait_port))
