...
class chatterRoomWindow1(QDialog,QWidget,form_chatterRoom):
    ip = 'localhost'
    port = 1111
    # 채팅방1
    wait_port = 9999
    ...
    def __init__(self,id):
        super(chatterRoomWindow1, self).__init__()
    ...
    def conn(self):
        ...
        self.conn_socket.connect((chatterRoomWindow1.ip, chatterRoomWindow1.port))
        self.conn_socket2.connect((chatterRoomWindow1.ip,chatterRoomWindow1.wait_port))
