...
class chatterRoomWindow2(QDialog, QWidget, form_chatterRoom):
    ip = 'localhost'
    port = 2222
    # 채팅방1
    wait_port = 9999
    ...
    def __init__(self, id):
        super(chatterRoomWindow2, self).__init__()
    ...
    def conn(self):
        ...
        self.conn_socket.connect((chatterRoomWindow2.ip, chatterRoomWindow2.port))
        self.conn_socket2.connect((chatterRoomWindow2.ip, chatterRoomWindow2.wait_port))
